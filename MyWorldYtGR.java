 ...
 */
public class MyWorldYtGR extends World
{
    public int Temp[][] = new int[4][4];
    public BoxYt B[][]= new BoxYt[4][4];
    CounterYt count=new CounterYt();
    BMenuYt menu =new BMenuYt();
    public int Score;
    int y = 140;
    int x = 136;
    int coordinate = 77;
    ...
    {    
        ...
        if (load != 1) {
            ...
            B[rand1][rand2] = new BoxYt(2);
            B[3-rand1][3-rand2] = new BoxYt(2);
            ...
            for(int j=3;j>=0;j--)
            {
                ...
                {   int k=i; 
                    ...
                    { 
                        ...
                        if(Temp[k-1][j]==0)
                        {   Temp[k-1][j]=Temp[k][j];
                            B[k-1][j].spawnBoxYt(Temp[k-1][j]);
                            addObject(B[k-1][j],xCo,yCo);

                            Temp[k][j]=0;
                            removeObjects(getObjectsAt(xCo,yCo+x,BoxYt.class));
                            if(Temp[i][k-1]==512) {
            ...
            for(int j=2 ;j>=0;j--)
            {
                ...
                {   int k=j; 
                    ...
                    { 
                        ...
                        if(Temp[i][k+1]==0)
                        {   Temp[i][k+1]=Temp[i][k];
                            B[i][k+1].spawnBoxYt(Temp[i][k+1]);
                            addObject(B[i][k+1],xCo,yCo);

                            Temp[i][k]=0;
                            removeObjects(getObjectsAt(xCo-x,yCo,BoxYt.class));
                            if(Temp[i][k+1]==512) {
